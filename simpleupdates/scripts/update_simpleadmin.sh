...
install_lighttpd() {
    ...
    echo "www-data ALL = (root) NOPASSWD: /usr/sbin/iptables, /usrdata/tailscale, /bin/systemctl, /usr/sbin/ip6tables, /usrdata/simplefirewall/ttl-override, /bin/echo, /bin/cat" > /opt/etc/sudoers.d/www-data
...
echo -e "\e[1;31m2) Installing simpleadmin from the $GITTREE branch\e[0m"
			...
			wget $GITROOT/simpleadmin/www/dev.html
			sleep 1
